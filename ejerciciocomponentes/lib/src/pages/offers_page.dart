 ...
 _animateToIndex(i) => _controller.animateTo(_height * i, duration: Duration(seconds: 1), curve: Curves.fastOutSlowIn);
  ...
  return FloatingSearchBar(
    ...
    builder: (context, transition) {
     ...
     for (var p in listaDePosiciones.where((element) => element.nombre.contains(textController.text))) {
...
int index=0;
index=listaDePosiciones.indexWhere((note) => note.nombre.contains(p.nombre));
                          ...
                          Container(                             
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      child: Text(
                                        'Salario: ' + p.remuneracion.toString()+'€',
                                    ...
                                    Container(
                                     ...
                                     Container(
                                      child: Text(
                                        'Finaliza: ' + p.fechaFin.toIso8601String().substring(0,10),
                                        textAlign: TextAlign.left,
                                        style: TextStyle(color: Colors.black),
                                      ),
                                    ),
